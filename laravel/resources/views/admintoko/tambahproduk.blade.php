...
<div class="panel panel-primary">
    <div class="panel-heading">Tambah Produk</div>
        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ route('masterproduk.store') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('kategori') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4">
                <select class="form-control" id="kategori" class="form-control" name="kategori">
                    <option>Pilih ..</option>
